...
export default function Styleshorts() {
    ...
    return (
        <div>
            <div className="w-[100%] h-30 text-center text-5xl font-extrabold object-contain p-10">
                ...
                <div className="">
                    ...
                    <div className="w-[100%] pb-2 bg-neutral-200 rounded-xl flex justify-start items-start inline-flex relative z-10 p-3">
                        <p className="text-center text-black text-xl font-bold ">경기 검색</p>
                        <div className="w-[100%] relative bg-white rounded-xl inset-[2%] flex items-stretch p-3">
                    ...
                    <div className="w-[100%] h-[300px] relative bg-neutral-200 rounded-xl top-3">
