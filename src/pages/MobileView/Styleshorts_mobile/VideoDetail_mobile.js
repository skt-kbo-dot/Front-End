...
function VideoDetail() {
    ...
    //const BASE_URL = './samplejson/sample_shorts_detail_1.json'; //디자인 수정할때, sample데이터
    ...
    return (
        <div>
            ...
            <main className="px-[3%] justify-center items-center">
                <h1 className='pb-5 text-bold underline '>{video.title}</h1>
                <div className="p-2 bg-neutral-200 rounded-xl flex-col justify-start items-start inline-flex relative z-10">
                    <video controls autoPlay loop className='max-h-200px'>
